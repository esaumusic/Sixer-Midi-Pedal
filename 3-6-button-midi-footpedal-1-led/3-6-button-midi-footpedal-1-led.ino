...
// The number of leds
const int NUM_OF_LEDS = 1;
const int LED_PIN_NUM[NUM_OF_LEDS] = {12};
...
const int MIDI_NOTE_NUMS[NUM_OF_BUTTONS] = {36,37,38,39,40,41};
const int MIDI_NOTE_VELS[NUM_OF_BUTTONS] = {110, 110, 110, 110, 110, 110};
const int MIDI_CC_NUMS[NUM_OF_BUTTONS] = {36,37,38,39,40,41};
  ...
  for (int i = 0; i < NUM_OF_BUTTONS; i++)
  {
    ...
    if (buttons[i].fallingEdge())
    {
      ...
      if (midiMode == MIDI_MODE_NOTES)
        ...
        digitalWrite(LED_PIN_NUM[0],HIGH);
    }
    ...
    else if (buttons[i].risingEdge())
    {
      ...
      digitalWrite(LED_PIN_NUM[0],LOW);
    }
